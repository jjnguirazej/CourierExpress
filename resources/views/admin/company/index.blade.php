                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="file" name="company_logo" id="company_logo" class="form-control rounded-0">
                            @error('company_logo')
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" id="company_name" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="company_phone" id="company_phone" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="company_address" id="company_address" rows="2" class="form-control rounded-0">
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_city" id="company_city" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_state" id="company_state" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_zip_code" id="company_zip_code" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_country" id="company_country" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_gst" id="company_gst" class="form-control rounded-0"
                                @if(count ($companies_master) > 0)
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <button onclick="companyFormSubmit" class="btn btn-primary rounded-0">
